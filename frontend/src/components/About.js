...
function About() { 
  ...
  function GithubIcon(props) {
    const githubLink = 'https://github.com/johncarter6841-hub';
    ...
    function LinkedInIcon(props) {
      const LinkedInLink = 'https://www.linkedin.com/in/pushpendra-singh-541a53257/';
      ...
      function GithubIcon1(props) {
        const githubLink1 = 'https://github.com/simplecodeongithubrohit'; 
      ...
      function LinkedInIcon1(props) {
        const LinkedInLink1 = 'http://linkedin.com/in/rohit-dwivedi-523a2b241';  
        return (
  ...
  return ( 
    <div className="about">
      ...
      <section className="section section4">
        <div className="text">
        <h1 className="name" style={{ fontSize: '38px' }}>Rohit Dwivedi</h1>
        </div>
      </section>
      <section className="section section5">
        <div className="para">
          <p className="toto">Hey, I'm a aktu university student with a real passion for software development. I'm always up for a challenge, especially when it comes to solving problems creatively using Java. What really gets me excited is the opportunity to work on projects that have a real impact and push the boundaries of what's possible. I thrive in collaborative environments, so I'm really looking forward to working with a team to bring our ideas to life. I can't wait to see where this journey takes us and the amazing things we can achieve together!</p>
        </div>
      </section>
